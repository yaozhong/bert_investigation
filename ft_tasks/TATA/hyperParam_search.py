...
from tata_eval import evaluate

# define the global accessible file
kmer=5
epoch=30
data_path="/ws1/pretrain/randpt/data/TATA/TATA_human_0"
embedding="dnabert"
...
def loading_data(data_path, embedding, kmer):
	...
	train_ds_generator = DataLoader(train_dataset, batch_size, collate_fn=partial(my_collate_fn, kmer=kmer, dic=dic), num_workers=cores, worker_init_fn=fix_worker_init_fn) 
	...
	return train_ds_generator, dev_ds_generator
